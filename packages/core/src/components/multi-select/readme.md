...
| `internalId`                  | `internal-id`                    | The unique internal ID of the component.                                                              | `string`                                                                                    | `` `br-multi-select-${multiSelectId++}` `` |
...
| `shouldCloseOnSelect`         | `should-close-on-select`         | Determines if the component closes the popover when a user selects an item.                           | `boolean`                                                                                   | `false`                                    |
