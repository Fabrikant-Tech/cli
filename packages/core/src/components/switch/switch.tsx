...
export class Switch {
   ...
   */
  @Element() elm: HTMLBrSwitchElement;
  /**
   ...
   * @visibility hidden
   */
  @Prop({ reflect: true }) readonly internalId: string = `br-input-${switchId++}`;
  /**
  ...
  componentWillLoad() {
    if (this.value !== undefined) {
      ...
      this.internals?.setFormValue(valueToSet);
    }
  ...
  render() {
    ...
    return (
      <Host aria-checked={this.checked ? 'true' : undefined} role="checkbox">
        <div
          class={{
            'br-switch-wrapper': true,
            'br-switch-was-touched': isTouched || this.active === true,
            'br-switch-focused': this.focused || this.active === true,
            'br-switch-disabled': this.disabled,
            'br-switch-invalid': isTouched && !this.internalValidityState.valid,
          }}
        >
          <div
            class="br-switch-content"
          ...
          >
            <div class="br-switch-control">
              ...
              />
              <div class="br-switch-control-handle">
