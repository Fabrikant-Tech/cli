 ...
 */
@Component({
  tag: 'br-simple-chart-y-axis',
})
export class SimpleChartYAxis {
  /**
   ...
   * @visibility persistent
   */
  @Prop() type: 'value' | 'category' | 'time' | 'log' = 'value';
  /**
   ...
   * @visibility persistent
   */
  @Prop() min?: number | string | 'dataMin' = this.type === 'category' ? undefined : 'dataMin';
  /**
   * Determines the maximum value for the component.
   * @category Data
   * @visibility persistent
   */
  @Prop() max?: number | string | 'dataMax' = this.type === 'category' ? undefined : 'dataMax';
  /**
   ...
   * @category Data
   */
  @Prop() otherOptions: Omit<EChartsOption['yAxis'], 'data' | 'type' | 'position'>;
  /**
