...
The checkbox component can be controlled via the `checked` prop and managing state with the `valueChange` event.
...
<BrContainer verticalGap="16px" direction="column">
  <BrCheckbox value="acceptedTerms">
    <span>Accept Terms & Conditions</span>
  </BrCheckbox>
  <BrCheckbox value="acceptedNewsletter">
    <span>Send me weekly product update emails</span>
  </BrCheckbox>
  <BrCheckbox value="acceptedAnonymousTracking">
    <span>Provide anonymous usage statistics to help improve the product</span>
  </BrCheckbox>
</BrContainer>
```
...
```jsx live
<BrContainer verticalGap="16px" direction="column">
  <BrCheckbox size="Large">
    <span>Large</span>
  </BrCheckbox>
  <BrCheckbox size="Normal">
    <span>Normal</span>
  </BrCheckbox>
  <BrCheckbox size="Small">
    <span>Small</span>
  </BrCheckbox>
  <BrCheckbox size="Xsmall">
    <span>Xsmall</span>
  </BrCheckbox>
</BrContainer>
```
...
<BrContainer verticalGap="16px" direction="column">
  ...
  <BrCheckbox checked={false}>
    <span>Value is false</span>
  </BrCheckbox>
  <BrCheckbox indeterminate={true} value="checked">
    <span>Indeterminate</span>
  </BrCheckbox>
  <BrCheckbox disabled={true}>
    <span>Disabled</span>
  </BrCheckbox>
</BrContainer>
```
...
| `indeterminate`     | `indeterminate`       | Determines if the component is displayed in its indeterminate state.                                  | `boolean \| undefined`                                          | `undefined`                      |
